...
// price - ціна
// tags - метаінформація
// Доповни об'єкт квартири властивістю owner, значенням якого буде
//  об'єкт з інформацією про власника.
...
// // Присвоєння значень/ виразів звернення до відповідних властивостей об'єкта apartment.
...
//~ ОБЧИСЛЮВАЛЬНІ (computed) ВЛАСТИВОСТІ -  в JavaScript дозволяють вам динамічно визначати імена властивостей
//~ об'єкта під час його створення.
...
// Використовуючи синтаксис обчислювальних властивостей, доповни код оголошення об'єкта
//  credentials таким чином, щоб в результаті у нього були дві властивості:
//  email і password, ключі яких зберігаються у змінних emailInputName і passwordInputName.
...
// Оголошення змінних для імен властивостей
// const emailInputName = "email";
// const passwordInputName = "password";

// // Оголошення об'єкта credentials з використанням синтаксису обчислювальних властивостей
// const credentials = {
//     [emailInputName]: "henry.carter@aptmail.com", // Властивість email
//     [passwordInputName]: "jqueryismyjam"           // Властивість password
// };
